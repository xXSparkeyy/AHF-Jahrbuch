...
<nav>
	<div class="nav-wrapper light-green">
		...
		<ul class="right hide-on-med-and-down">
			...
			<?php }?>
			<li><a href="<?php $user = Login::checkUser(); echo $user?"/profile/me/":"/Signin/" ?>"><i class="material-icons left">account_circle</i><?php $user = Login::checkUser();if( $user ) { $u = new Profile( $user["user_id"] ); echo $u->getFirstName()." ".$u->getLastName(); } else { echo "Anmelden"; } ?></a></li>
			<?php if(Login::checkUser()){?>
